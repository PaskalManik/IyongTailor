<div id="wrapper">
  ...
  <ul class="sidebar navbar-nav">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
    ...
    <li class="nav-item">
      <a class="nav-link" href="admin-employee.php">
        ...
        <span>Employee Assignment</span></a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="admin_menu.php">
        <i class="fa fa-ticket"></i>
        <span>Menu Barang</span></a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="gaji.php">
        <i class="fa fa-money"></i>
        <span>Gaji Employee</span></a>
    </li>
    <li class="nav-item">
